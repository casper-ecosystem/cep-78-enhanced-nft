...
pub const TOKEN_TRACKER: &str = "token_tracker";
pub const REVERSE_TOKEN_TRACKER: &str = "reverse_token_tracker";
pub const TOKEN_HASH_TRACKER: &str = "token_hash_tracker";
pub const MINTED_TOKENS_AT_UPGRADE: &str = "number_at_upgrade";

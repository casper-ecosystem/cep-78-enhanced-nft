...
pub enum NFTCoreError {
    ...
    MissingBaseNFTMetadataKind = 146,
    InvalidBaseNFTMetadataKind = 147,
    MissingOptionalNFTMetadataKind = 148,
    InvalidOptionalNFTMetadataKind = 149,
    MissingAdditionalNFTMetadataKind = 150,

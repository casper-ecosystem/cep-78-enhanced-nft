...
pub enum NFTCoreError {
    ...
    MissingBurnMode = 105,
    InvalidBurnMode = 106,
    MissingForwardTracker = 107,
    InvalidForwardTracker = 108,
    MissingReverseTracker = 109,
    InvalidReverseTracker = 110,
    MissingAllOwnersSeedURef = 111,
    InvalidAllOwnersSeedURef = 112,

...
//pub(crate)  pub(crate) const ENTRY_POINT_BALANCE_OF: &str = "balance_of";
...
pub(crate) const ARG_PUBLIC_MINTING: &str = "public_minting";
...
pub(crate) const ARG_APPROVE_TRANSFER_FOR_ACCOUNT_HASH: &str = "approve_transfer_for_account_hash";
